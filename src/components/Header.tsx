...
const EasyInspireLogo = () => (
  <Link to="/" className="flex items-center gap-2">
    ...
    <span className="text-xl font-bold tracking-tight">
      ...
      <span className="text-orange">Inspire</span>
      <span className="text-muted-foreground text-xs font-normal">.eu</span>
    </span>
  </Link>
);
  ...
  <div className="bg-[#0e2a47] py-2 px-4 shadow-sm">
    <div className="container mx-auto flex items-center justify-between text-white text-sm">
      <div className="flex items-center gap-6">
        <a href="tel:+37066022174" className="flex items-center gap-2 hover:text-orange transition-colors">
          <Phone size={14} className="text-[#f27024]" />
          <span className="hidden sm:inline">+370 660 22174</span>
        </a>
        <a href="mailto:info@easyinspire.eu" className="flex items-center gap-2 hover:text-orange transition-colors">
          <Mail size={14} className="text-[#f27024]" />
          <span className="hidden sm:inline">info@easyinspire.eu</span>
        </a>
      </div>
      <div className="flex items-center gap-4">
        ...
        <a href="https://wa.me/37066022174" target="_blank" rel="noreferrer" className="hover:text-orange transition-colors">
