...
const DetailsAndCosts = () => {
  ...
  const countries = [
    ...
    { countryKey: 'Spain',       country: t('country.spain'),       businessPrice: t('price.business150'), options: [`${t('invitation.tourist')}: ${t('price.eur150')}`, `${t('invitation.business')}: ${t('price.eur150')}`, `${t('invitation.family')}: ${t('price.eur150')} ${t('invitation.perPerson')}`] },
